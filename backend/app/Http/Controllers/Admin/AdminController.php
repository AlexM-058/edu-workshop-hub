...
class AdminController extends Controller
{
     ...
     * Supports optional ?role=professor|referent|admin filter.
     *
     * Query params:
    ...
    public function users(Request $request): JsonResponse
    {
        ...
        if ($role && in_array($role, ['professor', 'referent', 'admin'], true)) {
    ...
    public function stats(): JsonResponse
    {
        return response()->json([
            ...
            'total_referents'  => User::where('role', 'referent')->count(),
