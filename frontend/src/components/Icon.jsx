const paths = {
  ...
  security: <path d="M12 2 4 5v6c0 5 3.4 9.7 8 11 4.6-1.3 8-6 8-11V5l-8-3Zm0 2.2 6 2.2V11c0 3.8-2.4 7.5-6 8.8A9.9 9.9 0 0 1 6 11V6.4l6-2.2Zm-1 4.3h2v5h-2v-5Zm0 6.5h2v2h-2v-2Z" />,
  settings: <path d="m19.4 13.5 2 1.5-2 3.5-2.4-1a7.4 7.4 0 0 1-1.8 1l-.3 2.5h-4l-.4-2.5a7.4 7.4 0 0 1-1.8-1l-2.3 1-2-3.5 2-1.5a7.7 7.7 0 0 1 0-2l-2-1.5 2-3.5 2.3 1a7.4 7.4 0 0 1 1.8-1L10.9 4h4l.3 2.5a7.4 7.4 0 0 1 1.8 1l2.4-1 2 3.5-2 1.5a7.7 7.7 0 0 1 0 2ZM13 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" />,
