...
export default function AdminDeleteWorkshopModal({ isOpen, onClose, onConfirm, isBusy }) {
  const { t } = useI18n()
      ...
      >
        <div className="flex items-start gap-4 p-6">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-error-container text-on-error-container">
            <Icon className="text-2xl text-error">delete_forever</Icon>
          </div>
          <div className="flex-1">
            <h3 className="mb-2 font-h3 text-xl text-primary">{t('admin.deleteWarningTitle')}</h3>
