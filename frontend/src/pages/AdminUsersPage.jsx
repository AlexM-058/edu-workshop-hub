...
const ROLE_FILTER_OPTIONS = [
  ...
  { value: 'professor', labelKey: 'admin.roleAttender' },
  { value: 'referent',  labelKey: 'admin.roleTeacher' },
...
export default function AdminUsersPage() {
  ...
  function roleName(role) {
    if (role === 'professor') return locale === 'de' ? 'Teilnehmer' : 'Participant'
    if (role === 'referent')  return locale === 'de' ? 'Referent' : 'Referent'
    return 'Admin'
  }
